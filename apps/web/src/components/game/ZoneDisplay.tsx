        ...
        <div className="bg-[#0f0f1a]/60 rounded-xl border border-[#2a2a4a] p-4 mb-5">
          {isRoute ? (
            ...
            <div className="flex items-center justify-between">
              ...
              {/* Shop Button - only in towns with Poke Mart */}
              {currentZone.name !== 'Pallet Town' && (
                <button
                  onClick={() => gameSocket.getShop()}
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-b from-[#3B4CCA] to-[#2a3b9a] text-white font-medium text-sm hover:from-[#4B5CDA] hover:to-[#3B4CCA] transition-all duration-200 active:scale-95"
                >
