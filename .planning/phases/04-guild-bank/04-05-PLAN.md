...
export function BankLogsTab() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="p-4 border-t border-slate-700 flex items-center justify-center gap-2">
          <button
...
- All 5 tab components are imported
...
Run: `npm run build` in apps/web to verify compilation
  ...
  <done>
GuildBankModal fully integrated with all five tabs (Currency, Items, Pokemon, Logs, Requests)
  </done>
</task>
...
2. All five tabs render and function correctly
...
6. Role-based visibility works (requests tab only for officers/leaders)
</verification>
...
<what-built>
Complete guild bank UI with all 5 tabs:
