...
**Theme: "Trade Pokemon"**
- [ ] **Trade Database Schema**: Create trades/trade_offers tables (#23)
- [ ] **Trade Requests**: Send trade request to online friends (#24)
- [ ] **Trade UI**: Select Pokemon to offer/request (#25)
- [ ] **Trade Confirmation**: Both parties confirm before executing (#26)
- [ ] **Trade History**: Log completed trades (#27)

**New Content:**
- [ ] Add Pewter City (town with Brock's Gym) (#28)
- [ ] Move Brock's Gym from Pallet Town to Pewter City (#29)
- [ ] Add Pewter Museum interaction (#30)

---

### Week 4: Pokemon Evolution
**Theme: "Watch Them Grow"**
- [ ] **Evolution Data**: Add evolution chains to pokemon_species (#31)
- [ ] **Level Evolution**: Trigger evolution at level thresholds (#32)
- [ ] **Evolution Animation**: Show evolution sequence UI (#33)
- [ ] **Cancel Evolution**: Option to stop evolution (Everstone) (#34)

**New Content:**
- [ ] Add Route 3 (east of Pewter City toward Mt. Moon) (#35)
- [ ] Add Jigglypuff, Clefairy, Zubat, Paras, Geodude to Route 3 (#36)
